...
import { collection, addDoc, serverTimestamp } from 'https://www.gstatic.com/firebasejs/9.6.9/firebase-firestore.js'
...
export function WriteNotes() {
    ...
    const saveChanges = async (e) => {
        e.preventDefault()
        await addDoc(productsCollection, { title: title, note: note, timestamp: serverTimestamp(), email: auth.currentUser.email, })
        navigate('/')
